...
import com.hospital.doctor.entity.Doctor;
import com.hospital.doctor.entity.DoctorAvailability;
import com.hospital.doctor.security.UserPrincipal;
import com.hospital.doctor.service.DoctorService;
...
public class DoctorController {
    ...
    public Doctor createDoctor(@Valid @RequestBody DoctorDTO doctorDto, Authentication authentication) {
        ...
        System.out.println("✅ Creating doctor for userId: " + userId);
        System.out.println("✅ User roles: " + userPrincipal.getRoles());
